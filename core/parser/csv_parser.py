...
class CSVParserLaBanquePostale:
    ...
    def comparer_avec_pdf(
        ...
        # Les libellés sont tronqués différemment dans CSV et PDF.
        # On utilise un multiset (Counter) pour gérer les transactions
        # identiques (même date+montant) qui pourraient apparaître plusieurs fois.
